    ...
    private function getFilterTemplate()
    {
        ...
        switch (true) {
            case $filterSetting->getDisplayMode() == DisplayMode::MODE_DROPDOWN:
                ...
                break;
            case $filterSetting->getSubcategoriesView() == \Amasty\Shopby\Model\Source\SubcategoriesView::FLY_OUT:
                $template = 'labels_fly_out.phtml';
                break;
            default:
                $template = 'labels_folding.phtml';
                break;
        }
