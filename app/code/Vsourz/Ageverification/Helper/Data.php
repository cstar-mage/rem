<?php
namespace Vsourz\Ageverification\Helper;

class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const XML_PATH_ENABLED = 'ageverification/general/enabled';
    ...
    {
        $allowedPages = $this->scopeConfig->getValue('ageverification/general/pages',
        \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    ...
    public function getHeight()
    {
        $height = $this->scopeConfig->getValue(
            'ageverification/general/popup_height',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
        if ($height == "auto") {
            return $height;
    ...
    public function getWidth()
    {
        $width = $this->scopeConfig->getValue(
            'ageverification/general/popup_width',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
        if ($width == "auto") {
            return $width;
    ...
    {
        $dissagreeblockId = $this->scopeConfig->getValue(
            'ageverification/general/notverifyblock',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        $agree = $this->scopeConfig->getValue(
            'ageverification/general/agree',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    ...
    {
        $disagree = $this->scopeConfig->getValue(
            'ageverification/general/disagree',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
