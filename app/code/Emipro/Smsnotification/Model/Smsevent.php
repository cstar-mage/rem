...
class Smsevent extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'emipro_smsnotification_smsevent';
     ...
     * @var string
     */
    protected $_cacheTag = 'emipro_smsnotification_smsevent';
     ...
     * @var string
     */
    protected $_eventPrefix = 'emipro_smsnotification_smsevent';
